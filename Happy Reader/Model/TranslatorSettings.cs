...
namespace Happy_Reader
{
	public class TranslatorSettings : SettingsJsonFile
	{
		...
		//todo make editable
		public HashSet<string> ClipboardProcessNames { get; set; }  = new(new[] { "ithvnr", "ithvnrsharp", "textractor" }, StringComparer.OrdinalIgnoreCase);
		...
		public bool OutputTranslation
		{
			get => _outputTranslation;
			set
			{
				if (_outputTranslation == value) return;
				_outputTranslation = value;
				if (Loaded) Save();
			}
		}
