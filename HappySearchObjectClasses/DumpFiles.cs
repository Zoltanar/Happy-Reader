...
namespace Happy_Apps_Core
{
	public static class DumpFiles
	{
		...
		public static WrittenTrait GetTrait(RootTrait root, string traitName) => PlainTraits.Find(x => x.Name.Equals(traitName) && x.TopmostParent == (int)root);

		public static WrittenTrait GetTrait(int traitId) => PlainTraits.Find(x => x.ID == traitId);

		public static WrittenTag GetTag(string name) => PlainTags.Find(x => x.Name == name);

		public static WrittenTag GetTag(int tagId) => PlainTags.Find(x => x.ID == tagId);
	}
}
