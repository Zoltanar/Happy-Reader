...
namespace Happy_Apps_Core
{
    public class CoreSettings : SettingsJsonFile
    {
        ...
        private DateTime _imageSyncDate = DateTime.MinValue;
        ...
        /// <summary>
        /// Date of last time VNDB images were synced.
        /// </summary>
        public DateTime ImageSyncDate
        {
            get => _imageSyncDate;
            set
            {
                if (_imageSyncDate == value) return;
                _imageSyncDate = value;
                if (Loaded) Save();
            }
        }
